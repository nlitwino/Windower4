...
function init_gear_sets()
	...
	sets.precast['Healing Magic']			= set_combine(sets.precast.FC,{head="Gnadbhod's helm",neck="Orochi nodowa",body="Haubergeon +1",hands="Heavy gauntlets",ring1="Ether ring",ring2="Serket ring",feet="Aurum sabatons"})
	...
	-- Weaponskill sets                     
	sets.precast.WS                         = {head="Hecatomb cap +1"      ,neck="Fotia gorget"      ,ear1="Fowling earring",ear2="Brutal earring"
